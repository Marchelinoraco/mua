...
export function UsersInviteDialog({
  ...
  const formSchema = z.object({
    email: z.email({
      error: (iss) =>
        iss.input === ''
          ? t('inviteDialog.validation.emailRequired')
          : undefined,
    }),
    role: z.string().min(1, t('inviteDialog.validation.roleRequired')),
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className=''>
                  <FormLabel>{t('inviteDialog.description')}</FormLabel>
                  <FormControl>
                    <Textarea
                      className='resize-none'
                      placeholder={t('inviteDialog.descPlaceholder')}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
